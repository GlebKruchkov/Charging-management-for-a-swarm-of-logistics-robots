...
class AntBrain(OnlineBrain[Map[SafeCell]]):
    ...
    def __init__(self, model: "Model[Map[SafeCell], typing.Self, SafeRobot]",
        ...
        self._to_chargers = new_pheromones(model.map.charge_ids)
        self._last = 0
    ...
    @typing.override
    def _go_to_charger(self, robot: SafeRobot, destination: int):
        pheromones = self._to_chargers[destination, robot.position, robot.direction]
        return self._go(robot, pheromones)
